...
const bool X_MIN_ENDSTOP_INVERTING = ture; // set to true to invert the logic of the endstop.
const bool Y_MIN_ENDSTOP_INVERTING = ture; // set to true to invert the logic of the endstop.
const bool Z_MIN_ENDSTOP_INVERTING = ture; // set to true to invert the logic of the endstop.
